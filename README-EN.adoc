...
* After tapping on _done "HHU Card Balance" should be shown in the list of the Scripts.
...
* Now when you go back and tap on _done_, the widget should be shown and you'll be able to see the current balance of your HHU Card.
